...
namespace EggBeater
{
  ...
  public:
    ...
    **/
    void encryptFiles(QObject* curr, QStringList fileNames, QString folderName, QProcess* proc);

    /**
      Decrypt the specified files with the specified cipher mode. Defaults to
      CFB if no cipher mode is passed.
    **/
    void decryptFiles(QObject* curr, QStringList fileNames, QString folderName, QString cipherMode, QProcess* proc);
